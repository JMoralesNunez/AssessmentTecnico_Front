                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Título de la
                                        lección</label>
                                ...
                                <div v-if="!isEdit">
                                    ...
                                    <input type="number" v-model.number="form.order" class="input-field"
                                        placeholder="Ej. 1" />
                                </div>
                            </div>
                        </div>
...
const handleSave = () => {
    if (form.title.trim()) {
        emit('save', { ...form, id: props.lesson?.id });
    }
};
</script>
